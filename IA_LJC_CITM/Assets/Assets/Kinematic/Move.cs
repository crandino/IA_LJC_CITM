...
public class Move : MonoBehaviour {
	...
	void Update () 
	{
        ...
        Quaternion rot = Quaternion.FromToRotation(aim.transform.forward, mov_velocity);
        aim.transform.rotation = rot * aim.transform.rotation;
        //arrow.transform.rotation = rot * arrow.transform.rotation;
        ...
        arrow.value = (mov_velocity.magnitude / max_mov_velocity) * arrow.maxValue;
